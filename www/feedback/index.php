...
$form['form-1'] = array(
  ...
  'cfg' => array(
    ...
    'from_name' => 'noreply',
    'to_email' => 'modern.technology.ua@gmail.com',
...
$form['form-3'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Вопрос',
    'title' => 'Оформление заказа Power bank MT WPB',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'noreply',
...
$form['form-4'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Вопрос',
    'title' => 'Оформление заказа Чехол-power bank MT PBC',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'noreply',
...
$form['form-5'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Вопрос',
    'title' => 'Оформление заказа QI чехол MT WRC',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'noreply',
...
$form['form-6'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Вопрос',
    'title' => 'Оформление заказа Power bank MT WPB + QI чехол MT WRZ',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'noreply',
...
if(isset($form[$act])) {
   ...
   $sb = array(); // subject и body
    ...
    $error[] = 'Немає настройок форми з іменем #'.$act;
 }
