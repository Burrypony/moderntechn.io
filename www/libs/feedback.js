             ...
             if(/textbox/i.test(cfg.notify)) {
                 ...
                 if(isset(answer.errors)) {
                     $.each(answer.errors, function(k,val) {
                      ...
                      if(bt.hasClass('callback-button')){
                          dataLayer.push({'event': 'formsend_call'});
                      }
                      if(bt.hasClass('ask-button')){
                          dataLayer.push({'event': 'formsend_question'});
                      }
                      if(bt.hasClass('power-bank-button')){
                          dataLayer.push({'event': 'formsend_power_bank'});
                      }
                      if(bt.hasClass('power-bank-cover-button')){
                          dataLayer.push({'event': 'formsend_case_pb'});
                      }
                      if(bt.hasClass('cover-button')){
                          dataLayer.push({'event': 'formsend_case'});
                      }
                      if(bt.hasClass('set-button')){
                          dataLayer.push({'event': 'formsend_set'});
                      }
